...
// Crear un arreglo multidimensional de ventas por región y producto
$ventas = [
    "Norte" => [
        "Producto A" => [100, 120, 140, 110, 130],
        "Producto B" => [85, 95, 105, 90, 100],
...
echo "Crecimiento de ventas (primer al último mes) por región y producto:\n";
$mayorCrecimiento = [
    'region' => '',
    'producto' => '',
    'crecimiento' => -INF 
...
foreach ($ventas as $region => $productos) {
    ...
    foreach ($productos as $producto => $ventasProducto) {
        ...
        // Actualizar el producto y la región con mayor crecimiento
...
echo "  Región: {$mayorCrecimiento['region']}\n";
echo "  Producto: {$mayorCrecimiento['producto']}\n";
echo "  Crecimiento: " . number_format($mayorCrecimiento['crecimiento'], 2) . "%\n";
