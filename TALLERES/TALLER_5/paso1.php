...
$ciudades = ["Nueva York", "Tokio","Londres","Paris","Sidney","Rio de Janeiro","Moscú","Berlín","Ciudad del Cabo","Toronto"];

// 2. Imprimir el arrgelo original
...
//Funcion para imprimir el numero de ciudades que inicien con l
function retornoCiudadaes($ciudades,$letra){
    foreach($ciudades as $conteoCiudad){
        if($conteoCiudad[0] == $letra){
            echo "La ciudad con esa letra son: $conteoCiudad\n";
        }
    }
}
retornoCiudadaes($ciudades,'S');
